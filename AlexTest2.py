...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.ButtonAbout.place(relx=0.56, rely=0.021, height=24, width=87)
        ...
        self.ButtonAbout.configure(text='''K-Mean''')
        self.ButtonAbout.bind('<Button-1>',lambda e:AlexTest2_support.generateKmean())
